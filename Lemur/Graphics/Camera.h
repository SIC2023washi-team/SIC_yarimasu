...
private:
    ...
    // デバッグ用
    DirectX::XMFLOAT3   target = { 0.0,15.7f,-10.5f };
    DirectX::XMFLOAT3   angle = {1.05f,/// DirectX::XMConvertToRadians(35),
        DirectX::XMConvertToRadians(0),DirectX::XMConvertToRadians(0) };
